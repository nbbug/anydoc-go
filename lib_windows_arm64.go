...
/*
#cgo LDFLAGS: -L${SRCDIR}/lib/windows_arm64 -lanydoc_go
*/
import "C"

import _ "embed"

// The archive is built with the MSVC toolchain (aarch64-pc-windows-msvc), so
...
//
//go:embed lib/windows_arm64/anydoc_go.lib
